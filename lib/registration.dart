...
class _MyAppState extends State<MyApp> {
  ...
  TextEditingController namectrl,emailctrl,passctrl,telctrl;
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(
          children: <Widget>[
            Icon(Icons.apartment_outlined,size: 200,color: Colors.blue,),
  ...
  void userSignIn() async{
    ...
    var url = "https://guvendedegilim.000webhostapp.com/login_flutter/signin.php";
    var data = {
      "email":emailctrl.text,
      "pass":passctrl.text,
    };
    ...
    return Column(
      children: <Widget>[
        ...
        MaterialButton(
            ...
            child: processing == false ? Text('Kayıt Ol',
              style: GoogleFonts.varelaRound(fontSize: 18.0,
                  color: Colors.blue),) : CircularProgressIndicator(backgroundColor: Colors.red)
        ),
